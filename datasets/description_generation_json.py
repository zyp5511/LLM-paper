...
def description_generation():
    ...
    args.existing_dataset = "./datasets/title-description-amazon-products.jsonl"
    args.output_dir = "./datasets/description_generation"
    ...
    write_data(data_1k, os.path.join(args.output_dir, "train_1k.json"))
    write_data(data_5k, os.path.join(args.output_dir, "train_5k.json"))
    write_data(data_10k, os.path.join(args.output_dir, "train_10k.json"))
    write_data(data_50k, os.path.join(args.output_dir, "train_50k.json"))
    write_data(train_200k, os.path.join(args.output_dir, "train_200k.json"))
    # write_data(dev, os.path.join(args.output_dir, "dev.jsonl"))
    write_data(test, os.path.join(args.output_dir, "test.json"))
